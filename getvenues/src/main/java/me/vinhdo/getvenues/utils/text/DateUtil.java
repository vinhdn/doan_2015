package me.vinhdo.getvenues.utils.text;
...
public class DateUtil {
     ...
     */
    public static boolean isDifferentDay(Date f1, Date f2) {
     ...
     */
    public static DateDistance dateDistance(Date f1, Date f2, boolean includeStartDate) {
        DateDistance df = new DateDistance();
        if (null == f1 || null == f2)
            return null;
        Calendar fmax = Calendar.getInstance(), fmin = Calendar.getInstance();

        f1 = DateUtil.removeTime(f1);
        f2 = DateUtil.removeTime(f2);
     ...
     * @param f2 If null returns null
     */
    public static DateDistance dateDistance(Date f1, Date f2) {
    ...
    public static int daysInterval(Date startDate, Date endDate,
        ...
        startDate = DateUtil.removeTime(startDate);
        Calendar start = Calendar.getInstance();
        start.setTime(startDate);

        endDate = DateUtil.removeTime(endDate);
