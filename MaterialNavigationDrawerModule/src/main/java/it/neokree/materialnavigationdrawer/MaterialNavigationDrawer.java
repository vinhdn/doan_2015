...
public abstract class MaterialNavigationDrawer<Fragment> extends ActionBarActivity implements MaterialSectionListener,MaterialAccount.OnAccountDataLoaded {
    ...
    public void setActionButtomMenu(int id){
        ...
        ll = (LinearLayout)getLayoutInflater().inflate(id,parent,false);
        parent.addView(ll);
    }

    public void changeHeightCustomHeader(float xx){
        customDrawerHeader.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, (int)(xx * drawer.getWidth())));
    }
